...
import {addcomment, CreatePost, deleteComment, editProfile, followUnfloow, Getallpost, getCurrectUser, getMyprofile, getUserProfile, LikePost} from "../controllers/user.controller.js"
...
userRouter.get("/feed" , isAuth ,  Getallpost)
